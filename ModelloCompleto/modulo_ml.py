...
def riconosci_carattere(crop_binario):
    ...
    # Il filtro LANCZOS preserva i dettagli geometrici del tratto, usa sinc, analizza una matrice 6x6 di
    # pixel vicini per calcolare il valore del nuovo pixel, migliiore integrità geometrica dei caratteri, riduce l'aliasing.
    ...
    # Questo indica un batch, larghezza, lunghezza e canale.
    img_array_cnn = img_array.reshape(1, 28, 28, 1)

    # Passiamo l'immagine modificata al modello. pred è una matrice (1x15) di probabilità.
    ...
    # Argmax restituisce l'indice della probabilità più alta. Con axis=1,
